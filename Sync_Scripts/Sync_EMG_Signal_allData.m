%Comparing Signals
cd('C:\Users\dum5\OneDrive - University of Pittsburgh\aResearch_Studies\Young_LongAdaptation\YL02\New Session')
close all
clear all
R=2;
ini=1;
...
data_PC2=[];
forcedataall=[];
H=btkReadAcquisition('Trial10.c3d');
...
%     load(['C:\Users\dum5\OneDrive - University of Pittsburgh\aResearch_Studies\Young_LongAdaptation\YL01\PC1\YL01\YL01_\EMG_Trial02_',num2str(i),'.mat'])
    ...
    load(['C:\Users\dum5\OneDrive - University of Pittsburgh\aResearch_Studies\Young_LongAdaptation\YL02\PC1\Rename\EMG_Trial10_',num2str(i),'.mat'])
    % EMG_PC2=EMGdata(:,end);
    ...
    load(['C:\Users\dum5\OneDrive - University of Pittsburgh\aResearch_Studies\Young_LongAdaptation\YL02\PC2\Rename\EMG_Trial10_',num2str(i),'.mat'])
    % EMG_PC1=EMGdata(:,end);
